# Contributing to toolregistry-server
...
Keep commit messages concise and focused on *why*, not *what*. One logical change per commit. This project uses conventional commits: `feat:`, `fix:`, `refactor:`, `chore:`, `docs:`.
